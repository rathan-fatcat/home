...
const SideBar = () => {
  return (
    <div className={`${styles.side_bar} shadow-md bg-white pt-5`}>
      <ul className="relative">
        <li className={`${styles.sidebar_item} relative`}>
          <a
          ...
          >
            ...
            <span
              className={`${styles.sidebar_text} font-semibold text-lg ml-3`}
            >
              Home
            </span>
          </a>
