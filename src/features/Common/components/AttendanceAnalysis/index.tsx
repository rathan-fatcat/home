...
const AttendanceAnalysis = (props: HighchartsReact.Props) => {
  return (
    <>
      <div className="text-blue-700 lg:font-semibold mt-4 lg:ml-auto lg:mr-8">
        <button className="flex flex-row items-center bg-indigo-100 px-10 py-2 rounded-3xl">
          <Image
            className="mr-2"
      ...
      <div className="w-full m-10 mt-10 lg:ml-20 flex flex-row bg-[#ffffff] drop-shadow-md">
        ...
        <div className="hidden md:flex flex-col justify-start items-center w-4/12 md:w-6/12">
          <span className="flex">
